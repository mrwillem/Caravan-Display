...
uint8_t Buffer_Rx2[34];
uint8_t Buffer_Tx2[128];
...
void I2C_scan_bus(void)
{
	...
	{
		number=i;
		timedisplay_data[0]=(number%10);
		number=number/10;
		timedisplay_data[1]=(number%10);
		number=number/10;
		timedisplay_data[2]=number;
		LCD_Display8BitChar(80 ,j*40,(32+timedisplay_data[2]));
		LCD_Display8BitChar(100 ,j*40,(32+timedisplay_data[1]));
		LCD_Display8BitChar(120, j*40 ,(32+timedisplay_data[0]));
		if(i2c_write((i & 0b11111110),0x00, 0x00))
		{
			j++;
		}
	}
